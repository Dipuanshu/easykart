...
function Cart({ cart, updateCart }) {
  ...
  return (
    <>
      <div className="flex md:p-5 mx-1 mt-8 text-sm bg-gray-400 border border-black md:gap-14 md:mx-12 md:text-base md:gap-8 py-5 justify-between px-5 md:justify-normal">
        <div className="px-0 font-bold md:px-36 pl-5">Product</div>
        ...
        return (
          <>
            <div className="mx-1 text-xs border border-black md:mx-12 md:text-base">
              <div className="flex items-center px-5 justify-between md:justify-normal">
